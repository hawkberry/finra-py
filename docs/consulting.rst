...
The ``finra-py`` library provides a production-ready foundation for working with the FINRA API Platform. It is open source and available under the terms of the `LICENSE <https://github.com/hawkberry/finra-py/blob/main/LICENSE>`__. For firms and organizations that need assistance beyond the library itself, I provide consulting services tailored to their technical requirements.
...
Bug reports and feature requests should be submitted through the ``finra-py`` `Issues Page <https://github.com/hawkberry/finra-py/issues>`__ on GitHub, rather than by email. Please see :ref:`help` for troubleshooting guidance.

.. raw:: html

  <p>
  <button id="email-btn" type="button"><b>Email Me</b></button>
  </p>
  <script>
    (function () {
